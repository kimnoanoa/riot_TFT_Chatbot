...
def get_beginner_deck_recommendation(last_recommended=None):
 ...
 decks = [
  ...
  "tip": "초반 골드 안정성과 후반 딜 중심 덱."},
  {"name": "아케나/루시안 덱", 
  "core": ["루시안","세나","말자하","럭스","갈리오","애쉬","타릭"], 
  "tip": "균형 잡힌 덱, 루시안 & 세나 중심으로 플레이."},
  {"name": "아이오니아 탱/서포터 덱", 
  "core": ["쉔","셴","세라핀","유미","아리","오공","사이온","베인"],
   "tip": "탱 + 서포터 중심 안정형 덱."},
  {"name": "프렐요드 탱/AD 덱",
   "core": ["볼리베어","애쉬","트린다미어","레넥톤","가렌","세주아니","노틸러스"],
    "tip": "앞라인 단단 + AD 딜 중심 조합."},
  {"name": "공허/딜 중심 덱",
   "core": ["카이사","말자하","초가스","바론 내셔","코그모","아펠리오스","에코"], 
   "tip": "후반 화력 좋은 공허 중심 덱."}
]
